...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-r from-[#4C76A3] to-[#203D5D] shadow-[#466c8e] text-gray-100">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="flex flex-col items-center text-center md:flex-row md:items-center md:space-x-4 md:text-left">
              ...
              <div>
                ...
                <p className="text-sm text-gray-300">
                  Platform belajar komunitas dari Himpunan Mahasiswa Teknik
          ...
          <div className="text-center md:text-left">
            ...
            <div className="mt-4 flex space-x-5 justify-center md:justify-start">
              <a
                href="https://www.instagram.com/himtiumt/"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href="https://github.com/himtiumt"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-primary transition-colors"
                aria-label="GitHub"
              ...
              <a
                href="https://www.linkedin.com/company/himti-umt/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-primary transition-colors"
                aria-label="LinkedIn"
        ...
        <div className="mt-8 border-t border-gray-700 pt-6 text-center text-sm">
          <p>
            &copy; {new Date().getFullYear()} HIMTI UMT. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
