            ...
            >
                ...
                <div className="p-3 rounded-xl bg-gray-200 text-secondary">
                    <div className="flex items-center gap-1 text-xs">
                        ...
                        <motion.span animate={{ y: [0, -2, 0] }} transition={{ duration: 0.8, delay: 0.1, repeat: Infinity, ease: "easeInOut" }}>●</motion.span>
                        <mospan animate={{ y: [0, -2, 0] }} transition={{ duration: 0.8, delay: 0.2, repeat: Infinity, ease: "easeInOut" }}>●</mospan>
                    </div>
                </div>
            </motion.div>
        )}
