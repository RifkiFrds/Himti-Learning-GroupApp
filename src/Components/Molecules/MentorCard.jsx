  ...
  return (
    ...
    >
      ...
      <div className="flex justify-center gap-4 mt-4">
        <a href={mentor.socials.github} target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-gray-800">
          <FaGithub size={20} />
        </a>
        <a href={mentor.socials.linkedin} target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-blue-600">
          <FaLinkedin size={20} />
        </a>
        <a href={mentor.socials.instagram} target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-pink-500">
          <FaInstagram size={20} />
        </a>
      </div>
    </motion.div>
