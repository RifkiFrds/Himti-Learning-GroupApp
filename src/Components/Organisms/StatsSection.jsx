...
import {
  ...
  FaCode, FaChalkboardTeacher, FaLaptopCode
} from 'react-icons/fa';
...
const StatsSection = () => {
  const stats = [
    { icon: <FaProjectDiagram className="w-8 h-8 text-purple-300" />, value: 300, label: 'Proyek Portofolio Dibuat' },
    { icon: <FaUsers className="w-8 h-8 text-purple-300" />, value: 5, label: 'Kelompok Belajar Aktif' },
    { icon: <FaSmile className="w-8 h-8 text-purple-300" />, value: 95, label: 'Kepuasan Peserta', suffix: '%' },
    { icon: <FaCode className="w-8 h-8 text-purple-300" />, value: 1000, label: 'Baris Kode Ditulis' },
    { icon: <FaChalkboardTeacher className="w-8 h-8 text-purple-300" />, value: 20, label: 'Sesi Mentoring' },
    { icon: <FaLaptopCode className="w-8 h-8 text-purple-300" />, value: 50, label: 'Kontribusi Open Source' },
  ];
  ...
  return (
    <section className="relative py-24 bg-gradient-to-br from-[#111827] to-[#1e1b4b] text-white overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full overflow-hidden leading-none">
        <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 400" preserveAspectRatio="none" className="relative block w-full h-[150px]">
      ...
      <div className="relative z-10 container mx-auto px-6">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="mt-4 text-lg text-purple-300">
            Setiap angka adalah cerita. Setiap cerita adalah bukti komitmen kami untuk tumbuh bersama.
          </p>
        </div>
