  ...
  const features = [
    {
      ...
      description:
        "Dapatkan bimbingan dari mentor yang berpengalaman di bidangnya.",
    },
    {
      icon: <FaMobileAlt className="w-8 h-8" />,
      title: "Akses Mudah",
      description:
        "Belajar kapan saja dan di mana saja dengan platform yang responsif dan insatallble diberbagai perangkat.",
    },
    {
      icon: <FaBookOpen className="w-8 h-8" />,
      title: "Materi Terupdate",
      description:
        "Materi pembelajaran yang selalu diperbarui sesuai perkembangan teknologi.",
    },
  ];
      ...
      <div className="container px-5 py-24 mx-auto">
        <div className="text-center mb-20">
          <h1 className="sm:text-3xl text-2xl font-bold title-font text-secondary mb-4">
            Kenapa Bergabung di Himti Learning Group?
          </h1>
          <p className="text-base leading-relaxed xl:w-2/4 lg:w-3/4 mx-auto text-gray-500">
            Alasan mengapa platform ini adalah tempat terbaik untuk perjalanan
            belajarmu.
          </p>
